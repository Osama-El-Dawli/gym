...
namespace GymDesktop
{
    public partial class AddMember : Form
    {
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            // Connection string
            string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\programming\C#\project\safe\gym\Database\GymDb.mdf;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=True";
